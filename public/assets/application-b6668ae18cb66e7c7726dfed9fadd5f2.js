  ...
  ready = function() {
    ...
    manageControls = function(position) {
      ...
      if (position === numberOfSlides - 1 || showControls === false) {
        return $("#hero_right_control").fadeOut();
      } else {
        return $("#hero_right_control").fadeIn("slow");
      }
    };
    currentPosition = 0;
    ...
    $(".control").bind("click", function() {
      ...
      currentPosition = ($(this).attr("id") === "hero_right_control" ? currentPosition + 1 : currentPosition - 1);
