...
(function($) {
    $.flexbox = function(div, o) {
        ...
        // TEST: add property initialDisplayValue, so you can set it when the flexbox loads
        ...
        if (o.initialDisplayValue !== '')
            $input.val(o.initialDisplayValue).removeClass('watermark');
        else
    ...
    $.fn.flexbox.defaults = {
        ...
        initialDisplayValue: '', // what should the value of the input field be when the form is loaded?
        initialHiddenValue: '', // what should the value of the hidden field be when the form is loaded?
        watermark: '', // text that appears when flexbox is loaded, if no initialDisplayValue is specified.  style with css class '.ffb-input.watermark'
